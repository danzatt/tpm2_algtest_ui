...
class TPM2AlgtestUI:
    ...
    def construct_ui(self):
        ...
        YUI.widgetFactory().createLabel(self.vbox,
            "The collected information do not contain any of your personal information.\n" \
            "It will be used for research purposes regarding the performance\n" \
            "and the security of the keys generated by your TPM.\n\n" \
