...
What to do:
1. Please read the information about the experiment below 2. Run the test by
   clicking 'Start TPM test' button. The test runs for approximately 1-4 hours.
3. Unplug USB disk, restart to your standard system, plug USB disk again 4.
Upload file(s) algtest_result_xxx.zip file from the USB disk at https://is.muni.cz/go/tpm
